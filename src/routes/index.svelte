...
<Cards noOfCards={10} on:next={() => (forestClicked = 0)} on:previous={() => (forestClicked = 0)}>
	<Card title="Biodiversity of India!">
		<p>
			India is a rich and diverse country with various cultures, languages, dances etc. But India's
			diversity doesn't just doesn't end there. India is also full of thousands of species of plants
			and animals, each unique in its own way.
		</p>
		<br />
	...
	<Card title="Flora">
		<p>
			...
			>,
			<HoverText width="200px" text="Hibiscus"><img src="/hibiscus.jpg" alt="Hibiscus" /></HoverText
			>,
			...
			> and
			<HoverText width="200px" text="Shirui Lily"><img src="/sl.jpg" alt="Shirui Lily" /></HoverText
			>.
			<br /><br />
	...
	<Card title="Forests">
		...
		<svelte:component this={Carousel}>
			...
			>
				<img src="/tropicalevergreen.jpg" alt="Tropical Evergreen Forests" class="h-175 md:h-300" />
				...
				{#if forestClicked === 1}
					...
					>
						...
						<p>
							Tropical evergreen forests are dense, multi-layered, and harbour many types of plants
							and animals. These forests are found in the areas receiving heavy rainfall (more than
							200 cm annual rainfall). They are very dense. Even the sunlight does not reach the
							ground. Numerous species of trees are found in these forests. In some regions, some
							types of trees shed their leaves at different times of the year. Therefore, these
							forests always appear green and are known as evergreen forests.
						</p>
					</div>
				{/if}
			</div>
			...
			>
				<img src="/tropicaldeciduous.jpg" alt="Tropical Deciduous Forests" class="h-175 md:h-300" />
			...
			>
				...
				{#if forestClicked === 3}
					...
					>
						...
						<p>
							A thorn forest is a dense, scrubland with vegetation characteristic of dry subtropical
							and warm temperate areas with a seasonal rainfall averaging 250 to 500 mm (9.8 to 19.7
							in).
						</p>
					</div>
				{/if}
				...
				{#if forestClicked === 4}
					...
					>
						...
						<p>
							...
							dry slopes of Shivalik Hills, Western and Central Himalayas. At altitides of more than
							3600 metres, Alpine vegetation in the form of junipers and birches are found. In
							India, these forests are found on the southern slopes of the Himalayas. Alpine
				...
				{#if forestClicked === 5}
					...
					>
						...
						<p>
							...
							subtropical regions. They are characterized by halophytic (salt loving) trees, shrubs
							and other plants growing in brackish to saline tidal waters. These wetlands are often
							found in estuaries, where fresh water meets salt water and are infamous for their
							impenetrable maze of woody vegetation.
						</p>
					</div>
				{/if}
			</div>
	...
	<Card title="Conservation Efforts">
		<p>
			...
			India. From the passing of <HoverText text="Wildlife Protection Act of 1972">
				<p>
					This Act provides for the protection of wild animals, birds and plants. It extends to the
					whole of India
				</p>
			...
			<li>
				...
				<b
					>535 <HoverText text="Wildlife Sanctuaries" width="300px">
						A Wildlife Sanctuary is a protected area of importance for flora, fauna, or features of
						geological or other interest, which is reserved and managed for conservation and to
			...
			<li>
				Various projects have been initiated such as <b
					><HoverText text="Project Tiger" width="300px">
						Project Tiger is a tiger conservation programme launched in April 1973 by the Government
				...
				<b
					><HoverText text="Project Great Indian Bastard" width="300px">
						Project Great Indian Bustard was launched by the Rajasthan state government in June 2013
						and aims to improve the population of the mostly neglected, Great Indian Bastard.
					</HoverText></b
				>.
			</li>
		</ul>
